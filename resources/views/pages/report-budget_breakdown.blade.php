...
<div class="page-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        @endphp
                        <li class="breadcrumb-item">Dashboard / {{$name_divisi[0]->nama_divisi}} Report Breakdown</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div style="float:right; background-color: #003f05; border-radius: 5px;">
                                            <h6 style=" size:15px; font-weight: bold; margin:0px; padding:2px 10px">Rp {{number_format($item->budget_all)}}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            {{-- <div class="media align-items-center"> --}}
                                ...
                                {{-- <div class="media-body right-chart-content">
                                    ...
                                    <div class="col-xl-12" style="float: right;"> --}}
                                        {{-- <p style="color: #ffffff; margin-top: 10px; font-size: 20px; margin-bottom: -10px;">Total</p> --}}
                                        {{-- <p style="font-size: 20px; margin: 0;"><strong>Total Budget <br></strong>
                                        <h5>{{$item->nama_sub_divisi}}</h5>
                                        </p>
                                        <h6 style="float:right; background-color: #006608; padding: 2px 10px; border-radius: 25px; size:12px; font-weight: normal;">Rp {{number_format($item->amount)}}</h6>
                                    </div> --}}
                                {{-- </div> --}}
                            {{-- </div> --}}
                        </div>
    ...
    <input type="hidden" id="id_divisi_pdf" value="{{$dataReport[0]->id_divisi}}">
            ...
            <div class="col-sm-12">
                ...
                <div class="card-body">
                        <div class="table-responsive">
                            <button class="btn btn-secondary" style="float: right;" onclick="downloadpdfbreakdown()" ><i class="fa fa-print"></i> Print Report</button>
                            <br>
                            <table id="basic-2" class="display myTable">
                                <thead>
                                    <tr style="background-color: #1599d1; color: #fff;">
                                        <th>No</th>
                                        <th>Nama DIvision</th>
                                        <!-- <th>Amount</th> -->
                                        <th>Nama Sub Division</th>
                                        <th>Created Date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="details-control-report">{{$val->nama_sub_divisi}}</td>
                                        <td>{{ date('d-M-Y', strtotime($val->created_date)) }}</td>
                                        <td class="text-right">Rp {{($val->budget_all == null) ? 0 : number_format($val->budget_all)}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
