    ...
    <header>
        ...
        <div class="row">
            <div class="col-sm-4 text-center">
              <p style="margin-top: 0px; font-size: 110%; text-align:center"><b>REPORT DATA SUB BREAKDWON BUDGET </b></p>
            </div> 
          </div>
    </header>
    <main>
    <table>
      <thead>
        <tr style="border: 1px black solid;">
            ...
            <th style="border: 1px black solid;">NAMA BREAKDOWN</th>
            <!-- <th style="border: 1px black solid;">AMOUNT</th> -->
            <th style="border: 1px black solid;">NAMA SUB BREAKDOWN</th>
            <th style="border: 1px black solid;">AMOUNT SUB BREAKDOWN</th>
        </tr>
        </thead>
        <tbody>
          @php
        ...
        @foreach ($getsubBreakdown as $val)
          <tr style="border: 1px black solid;">
                ...
                <td  align="center" style="border: 1px black solid;" >{{ $val->nama_sub_breakdown }}</td>
                <td  align="right" style="border: 1px black solid;" >Rp {{($val->amount_sub == null) ? 0 : number_format($val->amount_sub)}}</td>
            </tr>
            @php
                $total += ($val->amount_sub == null) ? 0 : $val->amount_sub;
            @endphp
        @endforeach
        <tr style="border: 1px black solid;">
